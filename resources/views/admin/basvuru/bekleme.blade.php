...
<div class="container" >
    ...
    <div class="row justify-content-center" style="margin-top:10%;">
        ...
        <div class="col-md-12">
          <div class="card bg-dark">
              <div class="card-body">
                <h3>Merhaba {{Auth::user()->name;}}, {{$basvurular->onay}} başvuruları görüntülüyorsun.</h3>
    ...
    @foreach($basvurular->routes as $route)
      <div class="col-md-6">
        <div class="card card-{{$i}} card-0 mb-5">
          <div class="card-body">
            <a href="/admin/listele/{{$route}}/{{$basvurular->tip}}"  ><i class="bi bi-circle-square"></i> {{ucfirst($route)}} olan Başvuruları Görüntüle</a><br><br>
            <p>Bu alanda sadece {{$route}} olan başvurular yer alacaktır. </p>
            <a href="/admin/listele/{{$route}}/{{$basvurular->tip}}"  >Görüntüle</a><br><br>
