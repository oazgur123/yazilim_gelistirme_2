      ...
      <body class="bg-white" >
          <div class="relative flex items-top justify-center min-h-screen bg-white sm:items-center py-4 sm:pt-0">
              ...
              <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                          ...
                          <img src="https://www.logovector.org/wp-content/uploads/logos/png/k/kocaeli_universitesi_logo.png" alt="" style="width:100%">
                          <p class="text-center" style="font-width:bold;">Özgür Gizem Laravel Proje Ödevi</p>
